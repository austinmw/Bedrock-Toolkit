"""Example of a conversational agent with cached replies using the Bedrock Toolkit"""
...
def main() -> None:
    ...
    st.subheader("with DynamoDB Cached Response History")
    ...
    def get_conversation_manager() -> ConversationManager:
        ...
        return ConversationManager(
            ...
            cache_config={
                ...
                * 5,  # Cache time interval in seconds (5 minutes)
